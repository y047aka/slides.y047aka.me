...
var $w0rm$elm_slice_show$SliceShow$SlideData$update = F3(
	function (updateCustom, customAction, slide) {
		var _v0 = A3($w0rm$elm_slice_show$SliceShow$ContentData$update, updateCustom, customAction, slide.elements);
...
var $w0rm$elm_slice_show$SliceShow$show = function (_v0) {
	...
	var update = _v0.a.update;
	var view = _v0.a.view;
	var subscriptions = _v0.a.subscriptions;
	return $elm$browser$Browser$application(
		{
			init: F3(
				function (_v1, _v2, key) {
					var fragment = _v2.fragment;
					return _Utils_Tuple2(
						A2(
						...
						A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Portsを積極的に使うならモジュールバンドラーの方が有利のはず')
										]))
								])))
					]))
			]))
