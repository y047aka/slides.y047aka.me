...
var author$project$Main$build = _List_fromArray(
	[
		author$project$Formatting$padded(
		_List_fromArray(
			[
				author$project$Formatting$title('npm run build'),
				author$project$Formatting$text_('もう1つのコマンドは npm run build で起動します。'),
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('public にファイルが生成されます')
								]))
						]))),
				w0rm$elm_slice_show$SliceShow$Content$item(
				A2(
					...
					_List_fromArray(
						[
							A2(elm$html$Html$Attributes$style, 'font-size', '2.8rem'),
							A2(elm$html$Html$Attributes$style, 'color', '#999')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('生成前のファイルはすべて src にあるので、いつも通りに開発を進められます。')
						])))
			]))
	]);
...
var author$project$Main$characteristic = _List_fromArray(
	[
		author$project$Formatting$padded(
		_List_fromArray(
			[
				author$project$Formatting$title('特徴'),
				author$project$Formatting$bullets(
				_List_fromArray(
					[
						author$project$Formatting$bullet('モジュールバンドラーを使用しない'),
						author$project$Formatting$bullet('npm scripts に処理を記述する')
					]))
			]))
	]);
	...
	[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('Elm入門のための開発テンプレート')
								])),
							...
							_List_fromArray(
								[
									A2(elm$html$Html$Attributes$style, 'font-size', '15rem')
								]),
							_List_fromArray(
								[
				...
				author$project$Formatting$text_('Yoshitaka Totsuka')
			]))
	]);
...
var author$project$Main$intro = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				author$project$Formatting$title('elm-starfighter とは？'),
				author$project$Formatting$text_('Elmでの開発に必要な最低限を、'),
				author$project$Formatting$spacer(0),
				author$project$Formatting$text_('シンプルに使うためのテンプレートです。'),
				author$project$Formatting$bullets(
				_List_fromArray(
					[
						A2(author$project$Formatting$bulletLink, 'y047aka/elm-starfighter', 'https://github.com/y047aka/elm-starfighter')
					]))
			]))
	]);
var author$project$Main$jsLibraries = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				author$project$Formatting$title('モジュールバンドラーは必要？'),
				author$project$Formatting$text_('JavaScript の開発では、ESlint や Babel が必要とされ、'),
				author$project$Formatting$spacer(0),
				author$project$Formatting$text_('それらのライブラリを制御するために、'),
				author$project$Formatting$spacer(0),
				author$project$Formatting$text_('モジュールバンドラーが大活躍しています。'),
				author$project$Formatting$spacer(50),
				author$project$Formatting$text_('しかし、Elm にはコンパイラがあるので、'),
				author$project$Formatting$spacer(0),
				author$project$Formatting$text_('それらに頼らない開発が可能なはずです。')
			]))
	]);
var author$project$Main$policy = _List_fromArray(
	[
		author$project$Formatting$padded(
		_List_fromArray(
			[
				author$project$Formatting$title('開発の方針'),
				author$project$Formatting$bullets(
				_List_fromArray(
					[
						w0rm$elm_slice_show$SliceShow$Content$item(
						A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text('Elm入門者に優しく'),
									A2(elm$html$Html$br, _List_Nil, _List_Nil),
									A2(
									elm$html$Html$span,
									_List_fromArray(
										[
											A2(elm$html$Html$Attributes$style, 'font-size', '2.4rem'),
											A2(elm$html$Html$Attributes$style, 'color', '#999')
										]),
									_List_fromArray(
										[
											elm$html$Html$text('公式ガイドや『基礎からわかるElm』を読んだあとで、すぐに使えるように')
										]))
								]))),
						w0rm$elm_slice_show$SliceShow$Content$item(
						A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text('Elmの魅力を引き出す'),
									A2(elm$html$Html$br, _List_Nil, _List_Nil),
									A2(
									elm$html$Html$span,
									_List_fromArray(
									...
									_List_fromArray(
										[
											elm$html$Html$text('elm make のデバッグ機能なども使えるように')
										]))
								]))),
						w0rm$elm_slice_show$SliceShow$Content$item(
						A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text('モジュールバンドラーと戦わない'),
									A2(elm$html$Html$br, _List_Nil, _List_Nil),
									A2(
									elm$html$Html$span,
									_List_fromArray(
									...
									_List_fromArray(
										[
											elm$html$Html$text('Portを積極的に使うならモジュールバンドラーの方が有利のはず')
										]))
								])))
					]))
			]))
	]);
var author$project$Main$start = _List_fromArray(
	[
		author$project$Formatting$padded(
		_List_fromArray(
			[
				author$project$Formatting$title('npm start'),
				author$project$Formatting$text_('npm start を実行すると、'),
				w0rm$elm_slice_show$SliceShow$Content$item(
				A2(
					elm$html$Html$ol,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('docs にファイルが生成され')
								])),
							A2(
							elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text('開発用サーバーが起動し')
								])),
							A2(
							elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text('ブラウザに最初のページが表示されます')
								]))
						])))
			]))
	]);
...
var author$project$Main$usage = _List_fromArray(
	[
		author$project$Formatting$padded(
		_List_fromArray(
			[
				author$project$Formatting$title('簡単に使えるので書くことがない'),
				author$project$Formatting$text_('いちばん簡単な試し方'),
				author$project$Formatting$code('\n$ git clone https://github.com/y047aka/elm-starfighter.git\n$ cd elm-startfighter\n$ npm install\n$ npm start\n'),
				author$project$Formatting$spacer(30),
				w0rm$elm_slice_show$SliceShow$Content$item(
				A2(
					elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							elm$html$Html$text('リポジトリのトップから緑色のボタン「Use this template」を選択すると、'),
							A2(elm$html$Html$br, _List_Nil, _List_Nil),
							elm$html$Html$text('elm-starfighter を使った新しいリポジトリを作る事もできます。')
						])))
			]))
	]);
var author$project$Main$slides = _List_fromArray(
	[author$project$Main$cover, author$project$Main$jsLibraries, author$project$Main$intro, author$project$Main$characteristic, author$project$Main$policy, author$project$Main$usage, author$project$Main$start, author$project$Main$build]);
